...
namespace d3d
{
	...
	void init_trampolines()
	{
		...
		//sub_77EAD0_t                       = new Trampoline(0x0077EAD0, 0x0077EAD7, sub_77EAD0_r); // njDrawPolygon3D
		//sub_77EBA0_t                       = new Trampoline(0x0077EBA0, 0x0077EBA5, sub_77EBA0_r); // njDrawTriangle3D
