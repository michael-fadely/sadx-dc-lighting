...
extern "C"
{
	...
	EXPORT void __cdecl Init(const char *path, const HelperFunctions& helperFunctions)
	{
		...
		if (handle == nullptr)
		{
			MessageBoxA(WindowHandle, "SADX Lantern Engine will not function without d3d8to9 saved to your Sonic Adventure DX folder. Download d3d8.dll from from https://github.com/crosire/d3d8to9",
